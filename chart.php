...
?>
 ...
 var MQTTport = 80;
 var MQTTsubTopic = 'sensor/dht11/suhu';
 var MQTTsubTopic1 = 'sensor/dht11/humidity';
 var MQTTsubTopic2 = 'sensor/moisture/kelembabantanah';
 var chart;
 ...
 var options = {
  ...
  function onMessageArrived(message) {
    ...
    if(message.destinationName == "sensor/dht11/suhu") {
        ...
        var plotMqtt = [str, Number(thenum)];
    ...
    // document.getElementById("far").innerHTML = message.payloadString + "° F";
        ...
        var z = dataTopics1.indexOf(message.destinationName);
        const str1 = new Date().toLocaleString('en-US', { timeZone: 'Asia/Jakarta' });
     
       
        var thenum1 = message.payloadString.replace( /^\D+/g, '');
        var plotMqtt1 = [str1, Number(thenum1)];
    ...
    if(dataTopics2.indexOf(message.destinationName) < 0){
        ...
        var ez = dataTopics2.indexOf(message.destinationName);
        const str2 = new Date().toLocaleString('en-US', { timeZone: 'Asia/Jakarta' });
        
        // console.log(myEpoch2);
       
        var thenum2 = message.payloadString.replace( /^\D+/g, '');
        var plotMqtt2 = [str2, Number(thenum2)];
